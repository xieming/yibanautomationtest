...
import com.yiban.automation.pageobject.ZhucePage;
import com.yiban.automation.utils.WebDriverWrapper;

public class AbstractzhuceTestCase extends AbstractBaseTestCase {

    public void Register(String email, String nichen, String password, String conpwd) {
...
//                .startRaWeb(TestConfiguration.pageLoadWaitTime);
 ...
 //       libraryPage.exitRaweb();
    	ZhucePage zhucePage = new ZhucePage(driver);
    	zhucePage.zhuce(email,nichen, password, conpwd);
