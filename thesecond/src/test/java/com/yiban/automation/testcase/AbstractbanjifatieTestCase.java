...
import com.yiban.automation.pageobject.BanjiactivityPage;
...
public class AbstractbanjifatieTestCase extends AbstractLoginTestCase {

    public void bjFaXinTie(String title, String neirong) {
...
//                .startRaWeb(TestConfiguration.pageLoadWaitTime);
 ...
 //       libraryPage.exitRaweb();
    	...
    	BanjiactivityPage banji = new BanjiactivityPage(driver);
    	banji.banjifaxintie (title, neirong);
