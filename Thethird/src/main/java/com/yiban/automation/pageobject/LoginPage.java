...
public class LoginPage extends Page {
	...
	//	this.clickLoginButton();
		driver.get("http://www.yiban.cn/login");
		...
		WebDriverWrapper.waitPageLoad(driver, 3);
	//	if (driver.findElement(By.xpath("//div[2]/div/div/div[@class='login_tips']")).isDisplayed())
	//	{
	//		System.out.println("您输入的账号或密码不正确，请重新输入");
	//	}
	//	if (driver.findElement(By.cssSelector("a.login_go_disable")).isDisplayed())
	//	{
	//		System.out.println("您输入的账号或密码不正确，请重新输入");
	//	}
	/*	System.out.println("您输入的账号或密码不正确，请重新输入");
