...
public class AbstractfatieTestCase extends AbstractLoginTestCase {

    public void FaXinTie(String title, String neirong) {
...
//                .startRaWeb(TestConfiguration.pageLoadWaitTime);
 ...
 //       libraryPage.exitRaweb();
    	...
    	XiaoyuanactivityPage xiaoyuan = new XiaoyuanactivityPage(driver);
    	xiaoyuan.clickxiaoyuanhuodong();
    	xiaoyuan.faxintie (title, neirong);
